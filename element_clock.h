...
private:
	...
	ELEMENT_CLOCK(ID2D1HwndRenderTarget*, BRUSH_SET*, IDWriteTextFormat*, float pos_x, float pos_y, unsigned id, unsigned in_elapse, MASTER* Master);
	~ELEMENT_CLOCK();
...
public:
	static ELEMENT_CLOCK* Create(ID2D1HwndRenderTarget*, BRUSH_SET*, IDWriteTextFormat*, float pos_x, float pos_y, unsigned id, unsigned in_elapse, MASTER* Master);
